...
btn_f16.grid(row = 0, column = 0, sticky = N+E+W+S, padx = 3, pady = 3) # 동 서 남 북으로 해당 버튼을 붙임
...
btn_enter.grid(row = 4, column = 3, rowspan = 2, sticky = N+E+W+S, padx = 3, pady = 3) # 현재 위치로부터 아래쪽으로
